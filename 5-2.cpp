			...
			else
			{
				...
				if (key == 2)
				{
					...
					if (choice == 2)
					{
						...
						_Dmatrix2.show();
						cout << " Матрица после изменения \n";
						_Dmatrix2.putElem(row, col, dnum);
						_Dmatrix2.show();
						system("pause");
						break;
					}
					if (choice == 3)
					{
						...
						_Dmatrix3.show();
						cout << " Матрица после изменения \n";
						_Dmatrix3.putElem(row, col, dnum);
						_Dmatrix3.show();
						system("pause");
						break;
					}
				...
				if (key == 3)
				{
					...
					if (choice == 2)
					{
						...
						_Cmatrix2.show();
						cout << " Матрица после изменения \n";
						_Cmatrix2.putElem(row, col, cnum);
						_Cmatrix2.show();
						system("pause");
						break;
					}
					if (choice == 3)
					{
						...
						_Cmatrix3.show();
						cout << " Матрица после изменения \n";
						_Cmatrix3.putElem(row, col, cnum);
						_Cmatrix3.show();
						system("pause");
						break;
					}
